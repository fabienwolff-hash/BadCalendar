...
# BadPlanner — Journal des décisions d'architecture

## Objectif

Ce document recense les décisions d'architecture et de conception prises au cours du développement de BadPlanner.
